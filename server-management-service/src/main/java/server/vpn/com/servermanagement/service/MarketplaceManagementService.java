...
import server.vpn.com.servermanagement.client.UserManagementClient;
import server.vpn.com.servermanagement.dto.UserProfileDto;
import server.vpn.com.servermanagement.dto.mapper.SubscriptionPlanMapper;
import server.vpn.com.servermanagement.dto.response.PurchaseResponse;
...
import server.vpn.com.servermanagement.repository.SalesRecordRepository;
...
import static server.vpn.com.servermanagement.util.CountryCodeFlag.getCountryFlag;
...
public class MarketplaceManagementService {
    ...
    public PurchaseResponse purchaseSubscription(Authentication authentication, UUID subscriptionId, String billingCycle,
        ...
        connectionManagementService.incrementServerConnections(server);
